...
std::unique_ptr<Fractal> Fractal::Create(FractalParameters *params) {
...
std::function<double(const cmplx &z)>
Fractal::GetCouloringFunction(bool mandelbrot, int orbit_trap) {
  switch (orbit_trap) {
  case 0:
